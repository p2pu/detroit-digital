...
- See who signed up, edit the meeting  schedule, track attendance, etc
...
Using P2PU tools is required, P2PU will be the primary location to collect information about your learning circle and the status of learners. This information will be used for reporting and for ordering your devices.   You can also find resources and support from others in the community.
...
Learners will also need to create a P2PU account to complete the necessary device agreement and to have virtual access to all of the learning materials.

To facilitate or organize learning circles, you’ll first need to create a P2PU account, which you can do from the designated link to Join the Digital Skills Detroit Team. After setting your password, you will be logged in and redirected to your learning circle dashboard.
...
Participating  Learning Circles
This section of your Dashboard shows the learning circles you are participating in. This is the Learner view of the Course. From here participants can find links to all forms and surveys needed for the class and view the meeting schedule and learning material for the course.
...
P2PU offers a free system for creating and managing learning circle meetings. Once you've created a P2PU account, you can create your learning circle and publish it to the world. As a part of Digital Skills Detroit, your course will default to the Digital Skills Detroit Curriculum.

### Walkthrough: How to Create a Learning Circle
Creating a learning circle is a 5-step process.
1. **Select a Course:** Identify the learning materials you'll be using (Default Digital Skills Detroit Content)
![kix.e2wr9pwjxg9w](assets/uploads/kix.e2wr9pwjxg9w.png)
...
1. **Finalize:** Privately reflect on your goals for the learning circle and optionally ask for help if you need it. 
   1. ***Mandatory:*** Select the maximum number of signups for this course *This is mandatory and directly ties to how many devices are available to be allocated to your course.
   1. ***Optional:*** Choose someone from the Digital Skills Detroit Team to co-facilitate with you. 
![kix.ogj3c489n47i](assets/uploads/kix.ogj3c489n47i.png)



Once you complete the creation process and publish your learning circle (either as a draft or a public circle), your sign-up page will automatically be generated (see  image below for an example).
![kix.esbh5ciarcst](assets/uploads/kix.esbh5ciarcst.png)
...
![kix.j3lmbxlg95i](assets/uploads/kix.j3lmbxlg95i.png)
![kix.o9pfnqa7swzv](assets/uploads/kix.o9pfnqa7swzv.png)![kix.k3cgpn76wri](assets/uploads/kix.k3cgpn76wri.png)
...
- **View Content:** See the curated list of content for this learning circle. With links to Slides and PDFs
...
**Attendance** The Facilitator will see a list of all students under each meeting card and will need to check off their name to record their attendance.  This will be an important part of getting devices ordered.  Please keep up with your attendance.

## Learner  Dashboard

Learners will also need to create a P2PU account to complete the necessary device agreement and to have virtual access to all of the learning materials after they have signed up for the learning circle.

Learners will be able to see cards with learning circle information, and meetings as well as cards with prompts for forms that need to be completed.  The Device Agreement form resides here and is one of the necessary documents that need to be completed to receive their device.
![kix.4llwaiamgh0](assets/uploads/kix.4llwaiamgh0.png)![kix.kycpdja6m91w](assets/uploads/kix.kycpdja6m91w.png)![kix.o4m074pqmrhn](assets/uploads/kix.o4m074pqmrhn.png)
The top section of the page shows the title of learning circle. 
Below that is a teal  bar containing the following tools:
- **Email Facilitators:** Sends an email to the Facilitator's email address off of the platform.
- **View Signup Page:** See the live learning circle sign-up page.
- **View Content:** See the curated list of content for this learning circle. With links to Slides and PDFs
- **Leave:** Allow learners to opt out of the learning circle and leave the course.
